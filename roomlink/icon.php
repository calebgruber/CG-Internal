...
/**
 * roomlink/icon.php
 * Serves .icon files from roomlink/assets/icons/ with correct MIME type.
 *
 * Usage:  /roomlink/icon?name=MTA      → Metro-North / MTA
 *         /roomlink/icon?name=NJT      → NJ Transit
 *         /roomlink/icon?name=AMTK     → Amtrak
 *         /roomlink/icon?name=LIRR     → Long Island Rail Road
 *
 * The .icon files are PNG, SVG or similar images stored with a custom
 * extension so that direct HTTP access is blocked by .htaccess.
 * Place agency logo files in roomlink/assets/icons/<NAME>.icon
 */
